	  ...
	  _createClass(SPWidget, [{
	    ...
	    value: function run() {
	      ...
	      songPromise.then(function (result) {
	        ...
	        if (widget) {
	          var htmlString = '<div class="name">' + _this.name + '</div>';
	          htmlString += '<img src=' + _this.imageUrl + '></img>';
	          htmlString += '<audio src=' + _this.previewUrl + ' controls></audio>';
	...
	function getSongData(songId) {
	  ...
	  return fetch(url).then(function (response) {
	    if (response.ok) {
	      ...
	      console.error('Error in song id entered: ' + _this2.songId);
	    }
	  }).then(function (data) {
	    return data;
	  });
